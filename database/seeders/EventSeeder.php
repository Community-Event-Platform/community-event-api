...
- Tham gia đầy đủ các phần thực hành nấu ăn.',
                ...
                'image_url' => 'https://picsum.photos/seed/nauAn/400/250',
                'created_at' => $now,
                'updated_at' => $now,
            ],
            [
...
- Giữ gìn không gian nghệ thuật chung.',
                ...
                'require_additional_info' => false,
                'custom_form_spec' => null,
                'image_url' => 'https://picsum.photos/seed/trienLam/400/250',
                'created_at' => $now,
                'updated_at' => $now,
            ],
            [
...
- Tôn trọng ý tưởng và quan điểm của người khác.',
                ...
                'image_url' => 'https://picsum.photos/seed/khoiNghiep/400/250',
                'created_at' => $now,
                'updated_at' => $now,
            ],
            [
...
- Tuân thủ quy định và thời gian cuộc thi.',
                ...
                'image_url' => 'https://picsum.photos/seed/hackathon/400/250',
                'created_at' => $now,
                'updated_at' => $now,
            ],
            [
...
- Giữ thái độ lịch sự trong phần hỏi đáp.',
                ...
                'require_additional_info' => false,
                'custom_form_spec' => null,
                'image_url' => 'https://picsum.photos/seed/webinar/400/250',
                'created_at' => $now,
                'updated_at' => $now,
            ],
            [
...
- Khuyến khích tham gia các hoạt động giao lưu.',
                ...
                'require_additional_info' => false,
                'custom_form_spec' => null,
                'image_url' => 'https://picsum.photos/seed/sach/400/250',
                'created_at' => $now,
                'updated_at' => $now,
            ],
            [
...
- Tuân thủ quy định an toàn thực phẩm của sự kiện.',
                ...
                'require_additional_info' => false,
                'custom_form_spec' => null,
                'image_url' => 'https://picsum.photos/seed/foodFest/400/250',
                'created_at' => $now,
                'updated_at' => $now,
            ],
            [
...
- Tuân theo hướng dẫn của huấn luyện viên.',
                ...
                'image_url' => 'https://picsum.photos/seed/yoga/400/250',
                'created_at' => $now,
                'updated_at' => $now,
            ],
            [
...
- Tham gia đầy đủ phần trao đổi cuối buổi.',
                ...
                'require_additional_info' => false,
                'custom_form_spec' => null,
                'image_url' => 'https://picsum.photos/seed/cloud/400/250',
                'created_at' => $now,
                'updated_at' => $now,
            ],
            [
...
- Hoàn thành các bài tập trình bày được giao.',
                ...
                'image_url' => 'https://picsum.photos/seed/thuyetTrinh/400/250',
                'created_at' => $now,
                'updated_at' => $now,
            ],
            [
...
- Tôn trọng các hoạt động và diễn giả chia sẻ.',
                ...
                'require_additional_info' => false,
                'custom_form_spec' => null,
                'image_url' => 'https://picsum.photos/seed/tinhNguyen/400/250',
                'created_at' => $now,
                'updated_at' => $now,
            ],
            [
...
- Giữ vệ sinh khu vực picnic sau khi kết thúc.',
                ...
                'require_additional_info' => false,
                'custom_form_spec' => null,
                'image_url' => 'https://picsum.photos/seed/phim/400/250',
                'created_at' => $now,
                'updated_at' => $now,
            ],
            [
...
- Tôn trọng nội quy hội trường.',
                ...
                'image_url' => 'https://picsum.photos/seed/career/400/250',
                'created_at' => $now,
                'updated_at' => $now,
            ],
            [
